...
import com.protectos.ejemplo2.databinding.ActivityJuegoSuma26Binding
import com.protectos.ejemplo2.databinding.ScoresumaBinding
import kotlin.random.Random

class Actividad_Juego_Suma2_6 : AppCompatActivity() {
    private lateinit var vinculo: ActivityJuegoSuma26Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        vinculo= ActivityJuegoSuma26Binding.inflate(layoutInflater)
    ...
    private fun generateQuestion() {
        val num1 = Random.nextInt(500,999)
        val num2 = Random.nextInt(500, 999)
        vinculo.btnNum1.text = "$num1"
        vinculo.btnNum2.text = "$num2"
        suma=num1+num2

        val opciones = listOf(suma, suma - 10, suma + 20).shuffled()
