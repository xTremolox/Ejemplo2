...
import com.protectos.ejemplo2.databinding.ActivityJuegoSuma48Binding
import com.protectos.ejemplo2.databinding.ScoresumaBinding
import kotlin.random.Random

class Actividad_Juego_Suma4_8 : AppCompatActivity() {
    private lateinit var vinculo: ActivityJuegoSuma48Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        vinculo= ActivityJuegoSuma48Binding.inflate(layoutInflater)
