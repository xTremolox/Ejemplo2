...
class Actividad_Juego_Suma3_7 : AppCompatActivity() {
    private lateinit var vinculo: ActivityJuegoSuma37Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        vinculo= ActivityJuegoSuma37Binding.inflate(layoutInflater)
    ...
    private fun generateQuestion() {
        val num1 = Random.nextInt(40000,80000)
        val num2 = Random.nextInt(40000, 80000)
