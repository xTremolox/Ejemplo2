...
import com.protectos.ejemplo2.databinding.ActivityJuegoSuma21Binding
import com.protectos.ejemplo2.databinding.ScoresumaBinding
import kotlin.random.Random

class Actividad_Juego_Suma2_1 : AppCompatActivity() {
    private lateinit var vinculo: ActivityJuegoSuma21Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        vinculo= ActivityJuegoSuma21Binding.inflate(layoutInflater)
    ...
    private fun generateQuestion() {
        ...
        val opciones = listOf(suma, suma + 1, suma + 10).shuffled()
    ...
    private fun finalJuego() {
        ...
        vinculo2.btnSiguiente.setOnClickListener{
            ...
            val accion = Intent(this,Actividad_Juego_Suma2_2::class.java)
            startActivity(accion)
            overridePendingTransition(R.xml.fade_in, R.xml.fade_out)
            Handler(Looper.getMainLooper()).postDelayed({
                generateQuestion()
