...
import com.protectos.ejemplo2.databinding.ActivityJuegoSuma47Binding
import com.protectos.ejemplo2.databinding.ScoresumaBinding
import kotlin.random.Random

class Actividad_Juego_Suma4_7 : AppCompatActivity() {
    private lateinit var vinculo: ActivityJuegoSuma47Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        vinculo= ActivityJuegoSuma47Binding.inflate(layoutInflater)
    ...
    private fun generateQuestion() {
        val num1 = Random.nextInt(180000, 300000)
        val num2 = Random.nextInt(180000, 300000)
        vinculo.btnNum1.text = "$num1"
        vinculo.btnNum2.text = "$num2"
        suma=num1+num2

        val opciones = listOf(suma, suma + 5000, suma + 2000).shuffled()
    ...
    private fun validar(rpta: Int) {
        if (rpta==suma) {
            ...
            vinculo.score.text = "$correctAnswers/22"
            ...
            if (correctAnswers == 22) {
                Toast.makeText(this, "¡Felicidades! Has acertado 22 veces.", Toast.LENGTH_LONG).show()
                Handler(Looper.getMainLooper()).postDelayed({
                    generateQuestion()
                }, 1000)
    ...
    private fun finalJuego() {
        ...
        vinculo2.btnSiguiente.setOnClickListener{
            ...
            val accion = Intent(this,Actividad_Juego_Suma4_8::class.java)
            startActivity(accion)
            overridePendingTransition(R.xml.fade_in, R.xml.fade_out)
            Handler(Looper.getMainLooper()).postDelayed({
                generateQuestion()
