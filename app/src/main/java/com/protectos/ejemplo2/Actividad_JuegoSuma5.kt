...
import com.protectos.ejemplo2.databinding.ActivityJuegoSuma5Binding
import com.protectos.ejemplo2.databinding.ScoresumaBinding
import kotlin.random.Random

class Actividad_JuegoSuma5 : AppCompatActivity() {
    private lateinit var vinculo: ActivityJuegoSuma5Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        vinculo= ActivityJuegoSuma5Binding.inflate(layoutInflater)
