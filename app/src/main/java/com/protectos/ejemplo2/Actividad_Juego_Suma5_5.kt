...
class Actividad_Juego_Suma5_5 : AppCompatActivity() {
    ...
    private fun generateQuestion() {
        val num1 = Random.nextInt(300000,400000)
        val num2 = Random.nextInt(300000, 400000)
        vinculo.btnNum1.text = "$num1"
        vinculo.btnNum2.text = "$num2"
        suma=num1+num2

        val opciones = listOf(suma, suma + 1000, suma + 200).shuffled()
    ...
    private fun finalJuego() {
        ...
        vinculo2.btnSiguiente.setOnClickListener{
            ...
            val accion = Intent(this,Actividad_Juego_Suma5_6::class.java)
            startActivity(accion)
            overridePendingTransition(R.xml.fade_in, R.xml.fade_out)
            Handler(Looper.getMainLooper()).postDelayed({
                generateQuestion()
