...
import com.protectos.ejemplo2.databinding.ActivityJuegoSuma31Binding
import com.protectos.ejemplo2.databinding.ActivityJuegoSuma36Binding
import com.protectos.ejemplo2.databinding.ScoresumaBinding
import kotlin.random.Random

class Actividad_Juego_Suma3_6 : AppCompatActivity() {
    private lateinit var vinculo: ActivityJuegoSuma36Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        vinculo= ActivityJuegoSuma36Binding.inflate(layoutInflater)
    ...
    private fun generateQuestion() {
        val num1 = Random.nextInt(35000,60000)
        val num2 = Random.nextInt(35000, 60000)
        vinculo.btnNum1.text = "$num1"
        vinculo.btnNum2.text = "$num2"
        suma=num1+num2

        val opciones = listOf(suma, suma + 200, suma - 200).shuffled()
    ...
    private fun validar(rpta: Int) {
        if (rpta==suma) {
            ...
            vinculo.score.text = "$correctAnswers/20"
            ...
            if (correctAnswers == 20) {
                Toast.makeText(this, "¡Felicidades! Has acertado 20 veces.", Toast.LENGTH_LONG).show()
                Handler(Looper.getMainLooper()).postDelayed({
                    generateQuestion()
                }, 1000)
    ...
    private fun finalJuego() {
        ...
        vinculo2.btnSiguiente.setOnClickListener{
            ...
            val accion = Intent(this,Actividad_Juego_Suma3_7::class.java)
            startActivity(accion)
            overridePendingTransition(R.xml.fade_in, R.xml.fade_out)
            Handler(Looper.getMainLooper()).postDelayed({
                generateQuestion()
