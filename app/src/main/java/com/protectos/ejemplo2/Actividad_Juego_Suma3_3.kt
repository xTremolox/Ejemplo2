...
import com.protectos.ejemplo2.databinding.ActivityJuegoSuma33Binding
import com.protectos.ejemplo2.databinding.ScoresumaBinding
import kotlin.random.Random

class Actividad_Juego_Suma3_3 : AppCompatActivity() {
    private lateinit var vinculo: ActivityJuegoSuma33Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        vinculo= ActivityJuegoSuma33Binding.inflate(layoutInflater)
    ...
    private fun generateQuestion() {
        val num1 = Random.nextInt(7000,15000)
        val num2 = Random.nextInt(7000, 15000)
        vinculo.btnNum1.text = "$num1"
        vinculo.btnNum2.text = "$num2"
        suma=num1+num2

        val opciones = listOf(suma, suma + 50, suma + 80).shuffled()
