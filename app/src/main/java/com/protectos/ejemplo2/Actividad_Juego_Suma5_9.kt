...
import com.protectos.ejemplo2.databinding.ActivityJuegoSuma59Binding
import com.protectos.ejemplo2.databinding.ScoresumaBinding
import kotlin.random.Random

class Actividad_Juego_Suma5_9 : AppCompatActivity() {
    private lateinit var vinculo: ActivityJuegoSuma59Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        vinculo= ActivityJuegoSuma59Binding.inflate(layoutInflater)
    ...
    private fun generateQuestion() {
        val num1 = Random.nextInt(550000,800000)
        val num2 = Random.nextInt(550000, 800000)
        vinculo.btnNum1.text = "$num1"
        vinculo.btnNum2.text = "$num2"
        suma=num1+num2

        val opciones = listOf(suma, suma + 1100, suma + 150).shuffled()
    ...
    private fun validar(rpta: Int) {
        if (rpta==suma) {
            ...
            vinculo.score.text = "$correctAnswers/26"
            ...
            if (correctAnswers == 26) {
                Toast.makeText(this, "¡Felicidades! Has acertado 26 veces.", Toast.LENGTH_LONG).show()
                Handler(Looper.getMainLooper()).postDelayed({
                    generateQuestion()
                }, 1000)
    ...
    private fun finalJuego() {
        ...
        vinculo2.btnSiguiente.setOnClickListener{
            ...
            val accion = Intent(this,Actividad_Juego_Suma5_10::class.java)
            startActivity(accion)
            overridePendingTransition(R.xml.fade_in, R.xml.fade_out)
            Handler(Looper.getMainLooper()).postDelayed({
                generateQuestion()
