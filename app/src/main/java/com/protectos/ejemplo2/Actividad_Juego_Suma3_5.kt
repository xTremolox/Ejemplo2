...
import com.protectos.ejemplo2.databinding.ActivityJuegoSuma35Binding
import com.protectos.ejemplo2.databinding.ScoresumaBinding
import kotlin.random.Random

class Actividad_Juego_Suma3_5 : AppCompatActivity() {
    private lateinit var vinculo: ActivityJuegoSuma35Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        vinculo= ActivityJuegoSuma35Binding.inflate(layoutInflater)
    ...
    private fun generateQuestion() {
        val num1 = Random.nextInt(15000,40000)
        val num2 = Random.nextInt(15000, 40000)
    ...
    private fun finalJuego() {
        ...
        vinculo2.btnSiguiente.setOnClickListener{
            ...
            val accion = Intent(this,Actividad_Juego_Suma3_6::class.java)
            startActivity(accion)
            overridePendingTransition(R.xml.fade_in, R.xml.fade_out)
            Handler(Looper.getMainLooper()).postDelayed({
                generateQuestion()
